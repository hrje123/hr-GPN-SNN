...
def Parser():
    ...
    parser.add_argument('-T', default=60, type=int, help='simulating time-steps')
...
def main_val(args,i):
    ...
    net=model_func(T=args.T,dataset=args.data_name,single_step_neuron=neuron).to(device)
