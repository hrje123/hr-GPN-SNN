...
#snn
class SNN_base_1_1024_GLIF(nn.Module):
    def __init__(self, T, dataset, single_step_neuron: callable = None, **kwargs):
        super().__init__()
        ...
        self.fc1 = nn.Linear(700, 1024)
        self.sn1 = single_step_neuron(self.T,**kwargs)
        self.dp1 = methods.Dropout(0.25)
        self.fc2 = nn.Linear(1024, self.num_labels)
...
#snn
class SNN_base_3_1024_GLIF(nn.Module):
    def __init__(self, T, dataset, single_step_neuron: callable = None, **kwargs):
        super().__init__()
        ...
        self.fc2 = nn.Linear(1024, 1024)
        self.sn2 = single_step_neuron(self.T,**kwargs)
        self.dp2 = methods.Dropout(0.25)

        self.fc3 = nn.Linear(1024, 1024)
        self.sn3 = single_step_neuron(self.T,**kwargs)
        self.dp3 = methods.Dropout(0.25)
